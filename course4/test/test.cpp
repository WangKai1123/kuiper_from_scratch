...
TEST(test_ir, pnnx_graph_ops) {
  ...
  std::string bin_path("/home/wk/kuiper_from_scratch/course3/model_file/test_linear.pnnx.bin");
  std::string param_path("/home/wk/kuiper_from_scratch/course3/model_file/test_linear.pnnx.param");
